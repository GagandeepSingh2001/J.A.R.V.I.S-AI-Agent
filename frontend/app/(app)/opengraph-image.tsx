...
export default async function Image() {
  ...
  const isLogoUriLocal = logoUri.includes('arc_reactor');
  const wordmarkUri = logoUri === APP_CONFIG_DEFAULTS.logoDark ? 'public/arc_reactor.png' : logoUri;
