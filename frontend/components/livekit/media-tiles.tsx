...
const imageUrl = '/jarvis_hologram.png';
...
export function MediaTiles({ chatOpen }: MediaTilesProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-8 bottom-32 z-50 overflow-hidden md:top-12 md:bottom-40">
          ...
          >
            <AnimatePresence mode="popLayout">
              <motion.div
                ...
                className={cn(
                  chatOpen ? 'h-[90px] w-auto' : 'h-auto w-full',
